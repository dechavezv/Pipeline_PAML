...
export input=/data3/dechavezv/LRT/LRT_with_Jackal_20x/Wild_dog/Wild_dog_withJackal20x_raw_LRT_I.txt

echo '##############'
echo Editing_LRT_file
echo '##############'

grep -P -v "^\w+$" ${input} > Edited_${input} # delete empty line from file
